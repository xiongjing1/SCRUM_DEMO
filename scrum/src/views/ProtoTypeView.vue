<template>
  <div id="diva">
    <div id="left">
      <div style="width: 100%;height: 40px; line-height: 40px">项目名称</div>
      <div id="list">
        <ul style="padding: 0; width: 98%; margin: 0">
          <li v-for="(el,index) in prototypeData" :class="{classSelected:idSelected===el.id}"
            ...
            <i class="el-icon-edit" style="padding: 5px"></i>
            <i class="el-icon-delete-solid" @click.stop="deletePrototype(index)"></i>
          </li>
        </ul>
      </div>
      <div id="menu">
        <el-button type="primary" plain id="buttonAdd">添加</el-button>
        <el-dropdown>
          <el-button type="primary"  @click="allToPng">导出图片
            <i class="el-icon-arrow-down el-icon--right"></i>
          </el-button>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>jpg格式</el-dropdown-item>
            <el-dropdown-item @click="allToPng">png格式</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
    </div>
...
export default {
  ...
  data(){
    return{
      ...
      prototypeData:[
        ...
        {id:2 , name:"prototype3" , content:"" , width:300 , height:300},
        {id:3 , name:"prototype4" , content:"" , width:400 , height:400},
        {id:4 , name:"prototype5" , content:"" , width:500 , height:500},
        {id:5 , name:"prototype6" , content:"" , width:100 , height:100},
        {id:6 , name:"prototype7" , content:"" , width:200 , height:200},
        {id:7 , name:"prototype8" , content:"" , width:300 , height:300},
        {id:8 , name:"prototype9" , content:"" , width:400 , height:400},
        {id:9 , name:"prototype10" , content:"" , width:500 , height:500},
        {id:10 , name:"prototype1" , content:"" , width:100 , height:100},
        {id:11 , name:"prototype2" , content:"" , width:200 , height:200},
        {id:12 , name:"prototype3" , content:"" , width:300 , height:300},
        {id:13 , name:"prototype4" , content:"" , width:400 , height:400},
        {id:14 , name:"prototype5" , content:"" , width:500 , height:500},
        {id:15 , name:"prototype6" , content:"" , width:100 , height:100},
        {id:16 , name:"prototype7" , content:"" , width:200 , height:200},
        {id:17 , name:"prototype8" , content:"" , width:300 , height:300},
        {id:18 , name:"prototype9" , content:"" , width:400 , height:400},
        {id:19 , name:"prototype10" , content:"" , width:500 , height:500},
      ],
      canvasWidth:400,
      canvasHeight:400,
      dataArr:{},
      imgUrl:[require('../assets/PrototypeMaterial/picture.png'),
        require('../assets/PrototypeMaterial/map.jpg'),
        require('../assets/PrototypeMaterial/video.png'),
        require('../assets/PrototypeMaterial/code.jpg'),
        require('../assets/PrototypeMaterial/chat.png'),
        require('../assets/PrototypeMaterial/switch.png'),
        require('../assets/PrototypeMaterial/arrows.png'),
        require('../assets/PrototypeMaterial/pieChart.png'),
        require('../assets/PrototypeMaterial/button.png'),
        require('../assets/PrototypeMaterial/note.png'),
        require('../assets/PrototypeMaterial/location.png'),
        require('../assets/PrototypeMaterial/histogram.png'),]
  ...
  methods:{
    ...
    allToPng(){
      for(let i = 0 ; i <= 1 ; i ++){
        this.dataArr.canvas.clear()
        this.dataArr.canvas.setWidth(this.prototypeData[i].width)
        this.dataArr.canvas.setHeight(this.prototypeData[i].height)

        new fabric.Image.fromURL( this.materialData[0].imgURL, img => {
          this.dataArr.canvas.add(img.scaleToWidth(40)).renderAll()
        }, {crossOrigin: 'anonymous'})

        console.log(this.prototypeData[i].content)
        this.dataArr.canvas.loadFromJSON(this.prototypeData[i].content)
        this.dataArr.canvas.renderAll()
    ...
    deletePrototype(index){
      this.prototypeData.splice(index , 1)
      this.changeCanvas(this.prototypeData[index-1] , index-1)
    ...
    changeSize(){
      ...
      const rect1 = new fabric.Rect({
        top: 0, // 距离容器顶部 30px
        left: 0, // 距离容器左侧 30px
        width: this.canvasWidth, // 宽 100px
        height: this.canvasHeight, // 高 60px
        fill: 'red', // 填充 红色
    ...
    clear(){
      ...
      const rect1 = new fabric.Rect({
        top: 0, // 距离容器顶部 30px
        left: 0, // 距离容器左侧 30px
        width: this.prototypeData[this.idSelected].width, // 宽 100px
        height: this.prototypeData[this.idSelected].height, // 高 60px
        fill: 'white', // 填充 红色
    ...
    save(){
      const  json = JSON.stringify(this.dataArr.canvas.toJSON())
      const prototypeContent = this.prototypeData[this.idSelected]
      prototypeContent.content = json
      this.prototypeData.splice(this.idSelected , 1 , prototypeContent)
      console.log(this.prototypeData[this.idSelected].content)
    }
  },
  mounted() {
    this.init()
